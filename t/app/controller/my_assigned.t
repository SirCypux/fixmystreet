...
FixMyStreet::override_config {
    ...
    subtest "test report assignment" => sub {
        ...
        my $get_assignees = sub {
            ...
            return map {$_->content_list} @strong; # should be exactly 3
        };
        my @all_unassigned = qw((unassigned) (unassigned) (unassigned));
        is_deeply([$get_assignees->()], \@all_unassigned, 'all reports correctly unassigned');
